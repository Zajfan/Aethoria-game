export const CONFIG = {
  ...
  WORLD_3D: {
    TILE_SIZE:      4,    // Three.js units per tile — 4 = tiles are 4m wide
  ...
  DUNGEON_THEMES: {
    CRYPT: {
      ...
      wallColor:0x1a1818, floorColor:0x282420, fogDensity:0.05, bgColor:0x050405,
      ambientColor:0x150a0a, ambientIntensity:0.6,
      roomLightColors:[0x8866aa, 0xaa6688, 0x7755cc, 0xcc4466, 0x9944aa],
      accentColor:0xaa6688,
      decor:'BONES',
      intro:'The bones remember who they were. That memory makes them dangerous.',
      enemyBias:['SKELETON','ARCHER','LICH'],   bossTypes:['VOID_KNIGHT'],
    },
    FOREST: {
      name:'Corrupted Forest',
      wallColor:0x1a2e18, floorColor:0x0d1e0d, fogDensity:0.04, bgColor:0x050a05,
      ambientColor:0x061006, ambientIntensity:0.55,
      roomLightColors:[0x228833, 0x44aa44, 0x33cc55, 0x66bb22, 0x22aa66],
      accentColor:0x44cc44,
      decor:'MUSHROOMS',
      intro:'The roots have been growing for a hundred years. They have learned to want things.',
      enemyBias:['SPIDER','WOLF','PHANTOM'],    bossTypes:['FOREST_ANCIENT'],
    },
    VOLCANIC: {
      name:'Ashveil Depths',
      wallColor:0x3a1a08, floorColor:0x2a0e00, fogDensity:0.06, bgColor:0x0f0400,
      ambientColor:0x1a0800, ambientIntensity:0.7,
      roomLightColors:[0xff5500, 0xff8800, 0xdd3300, 0xff6600, 0xcc4400],
      accentColor:0xff6600,
      decor:'EMBERS',
      intro:'Ashveil burned before it became a dungeon. It is still burning. It will never stop.',
      enemyBias:['DRAKE','GOLEM','BERSERKER'],  bossTypes:['STONE_COLOSSUS'],
    },
    VOID: {
      name:'Void Rift',
      wallColor:0x080020, floorColor:0x040010, fogDensity:0.07, bgColor:0x020006,
      ambientColor:0x080020, ambientIntensity:0.5,
      roomLightColors:[0x7700ff, 0x9911ff, 0x5500dd, 0xaa22ff, 0x6600bb],
      accentColor:0x8822ff,
      decor:'CRYSTALS',
      intro:'The Void does not kill you. It replaces you with something that remembers being you.',
      enemyBias:['WRAITH','CULTIST','LICH'],    bossTypes:['VOID_HERALD'],
    },
    MARSH: {
      name:'Sunken Vaults',
      wallColor:0x091510, floorColor:0x081008, fogDensity:0.05, bgColor:0x030605,
      ambientColor:0x041008, ambientIntensity:0.55,
      roomLightColors:[0x22aa88, 0x44cc99, 0x33bbaa, 0x22998a, 0x55ddbb],
      accentColor:0x33ccaa,
      decor:'PILLARS',
      intro:'The vaults were built by someone who expected to return. They never did.',
      enemyBias:['PHANTOM','SPIDER','CULTIST'], bossTypes:['LICH_KING'],
    },
  ...
  // Each NPC has 3 hand-authored quests that reveal their personal lore arc.
  // Rewards: chain completion grants a unique permanent player bonus.
  NPC_CHAINS: {
    'Elder Lyra': {
      rewardKey:   'VOID_RESISTANCE',
      rewardLabel: 'Void Resistance',
      rewardDesc:  'Reduce all Void damage taken by 15% permanently.',
      chainEndText:'Elder Lyra places her hand on your shoulder. "What you feel now — that stillness when the Void presses — it is part of what I gave up at the Sealing. Apparently it found somewhere else to live. Carry it well."',
      quests: [
        {
          id: 'lyra_1',
          title: 'The Broken Sealing',
          type: 'KILL', target: 'wraith', needed: 5,
          reward: { xp: 320, gold: 60 },
          waypointX: 290, waypointZ: 216,
          giveText: 'The seals I placed sixty years ago are weakening. Wraiths press through the failing wards near the east marshes — drawn by the cracks, not wandering. Kill five of them. You need to understand what is coming through before I can tell you why.',
          completeText: 'You faced them. Good. Then you understand why the Sealing cost what it did. Come back when you are steadier. There is more.',
        },
        {
          id: 'lyra_2',
          title: 'What the Ground Remembers',
          type: 'COLLECT', target: 'void_herb', needed: 3,
          reward: { xp: 550, gold: 100 },
          waypointX: 296, waypointZ: 300,
          giveText: 'There is a herb. Nullwort. It only grows where Void energy has seeped into the soil. Mira has been studying it — she will not say why. I need three samples. The ritual requires something that has grown in the wound itself.',
          completeText: 'This is enough. Do not ask me what the ritual is for. What I will tell you is this: the cost of what I did was not only mine to bear. Others carry it too, and do not know it.',
        },
        {
          id: 'lyra_3',
          title: 'The Price of Memory',
          type: 'KILL', target: 'wraith', needed: 10,
          reward: { xp: 1100, gold: 200 },
          waypointX: 320, waypointZ: 240,
          giveText: 'The marshes east of the ruins — deeper this time. Ten Wraiths. They carry fragments of what the Sealing erased from this world. When you face them you will hear things. Do not look away from them. I need to know if you can hold what you hear.',
          completeText: 'Then you have heard it. You know what I gave up — and what I took from others without asking. Keep it. It becomes you now.',
        },
      ],
    },

    'Gareth': {
      rewardKey:   'MASTER_CRAFTING',
      rewardLabel: 'Master Crafting',
      rewardDesc:  'Unlocks advanced forge recipes: Crown Shard Blade, Void Plate, and Rune-forged armour.',
      chainEndText: 'Gareth sets his hammer down and looks at his remaining hand for a long moment. "The Crown Shard component. I thought I\'d never find it. But here we are." He pushes a worn leather journal across the bench. "Recipes. Things I\'ve been working out for thirty years. Yours now."',
      quests: [
        {
          id: 'gareth_1',
          title: 'Tempering the Steel',
          type: 'COLLECT', target: 'bones', needed: 6,
          reward: { xp: 280, gold: 80 },
          waypointX: 352, waypointZ: 240,
          giveText: 'Goblin bones. Six of them, whole. Before you ask — it\'s for the alloy. The marrow has something in it. Not magic, not exactly. Something structural. I\'ve been trying to work it out since the Battle of the Ember Road. Bring me the bones.',
          completeText: 'These will do. Don\'t look at me like that. Every good smith finds the material that changes what\'s possible. This is mine. Come back.',
        },
        {
          id: 'gareth_2',
          title: 'The Stone Core',
          type: 'KILL', target: 'golem', needed: 4,
          reward: { xp: 620, gold: 140 },
          waypointX: 396, waypointZ: 146,
          giveText: 'The replica Crown I\'ve been building — it fails. Every time. One component is missing and I think I know what it is. Golems carry it in their cores: a compressed mineral, formed under Void pressure. Kill four of them. Bring me what\'s at the centre.',
          completeText: 'There it is. Look at that — the way it holds the light. This is what the original Crown was forged with, I\'d stake my remaining arm on it. One more thing and we\'re close.',
        },
        {
          id: 'gareth_3',
          title: 'The Final Component',
          type: 'COLLECT', target: 'dragonscale', needed: 2,
          reward: { xp: 1200, gold: 250 },
          waypointX: 400, waypointZ: 136,
          giveText: 'Dragonscale. Two pieces, unscorched. The heat-resistance is secondary — it\'s the lattice structure I need. If my theory is right, this is what the outer casing of the Crown was made from. What the Voidlords were promised. What we could rebuild.',
          completeText: 'I\'ll need time with this. But the recipes — everything I\'ve worked out — that knowledge belongs to you now. You earned it.',
        },
      ],
    },

    'Mira': {
      rewardKey:   'HERB_MASTERY',
      rewardLabel: 'Herb Mastery',
      rewardDesc:  'All potions you use heal 30% more. Unlocks Nullwort Tea and Void Salve recipes.',
      chainEndText: 'Mira looks up from her notes. "You trusted me enough to do this without asking questions. That\'s rarer than you\'d think." She presses a small vial into your hand. "The healing you feel from herbs — it\'s more reliable in you now. I adjusted the formula. For you specifically."',
      quests: [
        {
          id: 'mira_1',
          title: 'The Nullwort Trail',
          type: 'COLLECT', target: 'herb', needed: 8,
          reward: { xp: 300, gold: 70 },
          waypointX: 296, waypointZ: 310,
          giveText: 'I need more herb samples — the ordinary kind, from the east fields. I\'m doing a comparison study. Where Void energy has touched the soil, the herbs change. I need a control group of unaffected specimens. Eight should be enough to establish the baseline.',
          completeText: 'Perfect. The difference is measurable. Look here — the cell structure in the affected ones is fundamentally altered. I\'m not certain the change is harmful. That\'s what worries me.',
        },
        {
          id: 'mira_2',
          title: 'Test Results',
          type: 'COLLECT', target: 'crystal', needed: 3,
          reward: { xp: 580, gold: 120 },
          waypointX: 376, waypointZ: 166,
          giveText: 'Void Crystal. Three pieces. The crystalline matrix stabilises the herb compound during extraction — without it the process is... unstable. I\'ve had three accidents already. I haven\'t told anyone about those. Bring me the crystals.',
          completeText: 'Good. No more accidents. I can proceed properly now. There\'s one more thing I need — and it\'s going to sound strange.',
        },
        {
          id: 'mira_3',
          title: 'What the Venom Shows',
          type: 'KILL', target: 'spider', needed: 12,
          reward: { xp: 980, gold: 200 },
          waypointX: 326, waypointZ: 336,
          giveText: 'Spider venom. Twelve spiders — I need enough venom to synthesize a catalyst. And before you ask: yes, the Nullwort reacts to it. When the venom is introduced to Void-altered herb tissue, something happens that I have not found a name for yet. I need more data.',
          completeText: 'Twelve. You actually did it without asking me why. Thank you. The formula works. I\'ve tested it on myself, which I should probably not have done. But I\'m better for it. I\'ll make sure you are too.',
        },
      ],
    },

    'Dorin': {
      rewardKey:   'GATE_FRAGMENT',
      rewardLabel: 'Gate Fragment',
      rewardDesc:  'A sliver of Void-touched luck. Permanent +10% gold from all sources.',
      chainEndText: 'Dorin reaches into his coat and produces a small dark shard — not stone, not metal, something else entirely. "I brought something back from the Gate. I thought it was a mistake. Turns out everything I\'ve sold since that day has sold better than it should have." He presses it into your palm. "It wants to go somewhere useful. That seems to be you."',
      quests: [
        {
          id: 'dorin_1',
          title: 'Market Research',
          type: 'COLLECT', target: 'gem', needed: 5,
          reward: { xp: 260, gold: 100 },
          waypointX: 160, waypointZ: 176,
          giveText: 'Gems. Five of them, assorted — I\'m not particular about cut. I\'m doing an appraisal project. Testing whether the Void energy that has been seeping through affects gemstone value. It shouldn\'t. But three of the last shipments I sold had stones that... reacted differently than they should have.',
          completeText: 'Yes. Look at this one — the refraction is wrong. Not defective, just wrong in a specific way. I\'ve seen this before. Not here. Somewhere else. Come back.',
        },
        {
          id: 'dorin_2',
          title: 'What Came Back With Me',
          type: 'COLLECT', target: 'soulstone', needed: 2,
          reward: { xp: 600, gold: 150 },
          waypointX: 352, waypointZ: 116,
          giveText: 'Soulstones. Two. I know what they are — condensed spiritual residue. I need them for a comparison. The thing I brought back from the Void Gate — it has a similar resonance signature. I need to know if it\'s something the Void made, or something it took.',
          completeText: 'Neither. It\'s something in between. Which is worse, in a sense, but also more interesting. Last thing. This one is about the Cultists.',
        },
        {
          id: 'dorin_3',
          title: 'The Other Side of the Gate',
          type: 'KILL', target: 'cultist', needed: 6,
          reward: { xp: 950, gold: 200 },
          waypointX: 366, waypointZ: 366,
          giveText: 'The Cultists who worship the Voidlords — they know something about the Gates. Not as much as they think they do, but something. Six of them. Not for revenge, not for glory. I just need you to be someone the item trusts. It makes its own decisions about that.',
          completeText: 'Good enough. The thing I brought back has been quiet for a long time. I think it\'s made its decision. Here.',
        },
      ],
    },

    'Capt. Vel': {
      rewardKey:   'VEL_BLESSING',
      rewardLabel: "Vel's Blessing",
      rewardDesc:  '+15% attack damage against all Void-type enemies permanently.',
      chainEndText: 'Capt. Vel does not smile. She does not offer her hand. She looks at you for a long moment the way she looks at a wall that has not fallen yet. "Four settlements," she says. "I held them all. This one I\'m going to hold differently." She writes something in her ledger. "You\'re on the standing order now."',
      quests: [
        {
          id: 'vel_1',
          title: 'Wall Patrol',
          type: 'KILL', target: 'goblin', needed: 20,
          reward: { xp: 400, gold: 80 },
          waypointX: 306, waypointZ: 276,
          giveText: 'East ridge. Twenty goblins. This is not a request — three of my guards called in sick, which means they deserted, which means the perimeter is compromised. This is the second time this month. Do not bring them back. Just clear the approach.',
          completeText: 'Twenty. No more, no less. You counted right. I respect that. Go rest. There will be more work.',
        },
        {
          id: 'vel_2',
          title: 'The Ember Road',
          type: 'KILL', target: 'bandit', needed: 10,
          reward: { xp: 700, gold: 150 },
          waypointX: 176, waypointZ: 186,
          giveText: 'The road west — the Bandits have been using it as a staging ground. Ten of them. This is the same road where I lost the third settlement I was supposed to hold. Different enemies. Same mistakes. I need to know the road is clear before I make a decision about the north approach.',
          completeText: 'The Ember Road. I haven\'t said that name out loud in four years. You did well. Faster than I expected. Last thing — and this one matters.',
        },
        {
          id: 'vel_3',
          title: 'The Standing Order',
          type: 'KILL', target: 'wraith', needed: 12,
          reward: { xp: 1300, gold: 280 },
          waypointX: 290, waypointZ: 216,
          giveText: 'The Wraiths pressing through the east — they\'re not random. Someone or something is sending them. My standing order says I hold the wall. It does not say what I hold it against. Twelve Wraiths. Kill them and I will tell you what the order actually says. All of it.',
          completeText: 'Twelve. The order says: hold until the Voidlords are stopped or there is no one left to stop them. I\'ve held four walls. This time I\'m going to hold the right one.',
        },
      ],
    },
  },
