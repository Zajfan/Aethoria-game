...
export const FACTIONS = {
  ...
  DAWNWARDENS: {
    ...
    color:    0xfff0aa,
    cssColor: '#fff0aa',
    desc:     'Paladins sworn to protect the realm. Rigid but honourable — their laws clash with local customs.',
    startRep: 0,
    npcRoles: [],
    unlocks: {
      300: { id: 'dawn_blessing',  label: 'Dawnwarden Blessing', desc: '+10% healing received.' },
      700: { id: 'dawn_paladin',   label: 'Ordained Paladin',    desc: 'Immune to STUN status effect.' },
    },
    penalties: {},
  },
  VEILBOUND: {
    ...
    color:    0x9944cc,
    cssColor: '#9944cc',
    desc:     'Shadow mages using forbidden magic to close the Void Gate. Feared, misunderstood, and running out of time.',
    startRep: -100,
    npcRoles: [],
    unlocks: {
      200: { id: 'veil_sight',   label: 'Void Sight',     desc: 'See enemy HP bars through walls within 8 tiles.' },
      600: { id: 'veil_master',  label: 'Veilbound Ally', desc: 'Void-type damage +25%.' },
    },
    penalties: {},
    rivalFaction: 'DAWNWARDENS',
    rivalPenalty: 0.8,
  },
  IRONFANG: {
    id:       'IRONFANG',
    ...
    color:    0xcc7733,
    cssColor: '#cc7733',
    desc:     'Mercenary warriors from a lost continent. Brutal, honourable, and surprisingly accurate about Void lore.',
    startRep: -50,
    npcRoles: [],
    unlocks: {
      300: { id: 'iron_strength', label: 'Ironfang Mark', desc: '+3 attack per 10 enemies killed (stacking).' },
      700: { id: 'iron_legend',   label: 'Warbrand',      desc: 'Melee hits apply BLEED at 30% chance.' },
    },
    penalties: {},
  },
  GUILD_WHISPERS: {
    ...
    color:    0x888888,
    cssColor: '#888888',
    desc:     'Spies and brokers who survive by being useful. They know the Lich King is returning and nobody believes them.',
    startRep: 0,
    npcRoles: [],
    unlocks: {
      400: { id: 'whisper_intel', label: 'Guild Intel',    desc: 'World event warnings 60s in advance.' },
      800: { id: 'whisper_ghost', label: 'Shadow Step',    desc: 'Enemies have 20% reduced detect range.' },
    },
    penalties: {},
  },
  VERDANT_FLAME: {
    ...
    color:    0x44bb44,
    cssColor: '#44bb44',
    desc:     'Druids preserving the wild places. They know something about forests and the Void that nobody has fully worked out.',
    startRep: 0,
    npcRoles: [],
    unlocks: {
      300: { id: 'verdant_growth',  label: 'Forest Bond',    desc: 'Herbs heal +30% more. Forest tiles restore 1 HP/s.' },
      700: { id: 'verdant_warden',  label: 'Grove Warden',   desc: 'Poison immunity. Nature-type spells deal +20% dmg.' },
    },
    penalties: {},
  },
  VOIDBORN: {
